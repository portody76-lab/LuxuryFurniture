    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 p-6 flex flex-col justify-between min-h-screen"
            ...
            <div>
                ...
                <nav class="space-y-2">
                    <a href="#"
                        class="block px-4 py-3 rounded-xl bg-white text-[#5a4a1e] font-medium text-sm transition-all duration-200 shadow hover:bg-[#c9973a] hover:text-white hover:shadow-lg">Dashboard</a>
                    <a href="#"
                        class="block px-4 py-3 rounded-xl bg-white text-[#5a4a1e] font-medium text-sm transition-all duration-200 shadow hover:bg-[#c9973a] hover:text-white hover:shadow-lg">Manage
                        Account Operator</a>
                    <a href="#"
                        class="block px-4 py-3 rounded-xl bg-[#c9973a] text-white font-medium text-sm transition-all duration-200 shadow">Product
                        Management</a>
                    <a href="#"
                        class="block px-4 py-3 rounded-xl bg-white text-[#5a4a1e] font-medium text-sm transition-all duration-200 shadow hover:bg-[#c9973a] hover:text-white hover:shadow-lg">Stock
                        Management</a>
                    <a href="#"
                        class="block px-4 py-3 rounded-xl bg-white text-[#5a4a1e] font-medium text-sm transition-all duration-200 shadow hover:bg-[#c9973a] hover:text-white hover:shadow-lg">Report</a>
                </nav>
            </div>
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button
                    class="w-full flex items-center gap-2 px-4 py-3 rounded-xl bg-white text-[#5a4a1e] font-medium text-sm transition-all duration-200 shadow hover:bg-[#c9973a] hover:text-white">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead>
                            <tr class="bg-[#f3e4c3]">
                                <th
                                    class="rounded-l-xl px-3 py-3 text-left font-semibold text-[#7a5c1e] text-xs tracking-wider">
                                    Image</th>
                                <th class="px-3 py-3 text-left font-semibold text-[#7a5c1e] text-xs tracking-wider">Kode
                                </th>
                                <th class="px-3 py-3 text-left font-semibold text-[#7a5c1e] text-xs tracking-wider">Nama
                                    Item</th>
                                <th class="px-3 py-3 text-left font-semibold text-[#7a5c1e] text-xs tracking-wider">
                                    Kategori</th>
                                <th class="px-3 py-3 text-left font-semibold text-[#7a5c1e] text-xs tracking-wider">Stok
                                </th>
                                <th
                                    class="rounded-r-xl px-3 py-3 text-center font-semibold text-[#7a5c1e] text-xs tracking-wider">
                                    Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                                            ...
                                            <div class="inline-flex items-center gap-2">
                                                ...
                                                <form method="POST" action="{{ route('products.destroy', $p) }}" class="inline">
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        onclick="return confirmDelete({{ $p->id }})">
                                        ...
                                        <div class="flex flex-col items-center gap-2">
                                            ...
                                            @if(request('search'))
                                                <a href="{{ route('operator.dashboard') }}"
                                                    class="text-[#c9973a] hover:underline text-sm">
                                                    Clear search
                                                </a>
                                            @endif
                                        </div>
