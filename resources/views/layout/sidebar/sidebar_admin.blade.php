        ...
        <nav class="space-y-2">
            ...
            <div class="relative">
                ...
                <div id="productSubmenu" class="mt-1 ml-6 space-y-1 hidden">
                    <a href="{{ route('contents.admin.products') }}"
                    ...
                    <a href="{{ route('contents.admin.stock') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg {{ request()->routeIs('contents.admin.stock') ? 'text-[#c9973a] font-semibold' : 'text-[#5a4a1e] hover:text-[#c9973a]' }} text-sm transition">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (currentRoute.includes('/products') || currentRoute.includes('/stock') || currentRoute.includes(
                '/mutasi')) {
            const submenu = document.getElementById('productSubmenu');
            const icon = document.getElementById('productSubmenuIcon');
