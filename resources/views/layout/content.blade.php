...
<body class="bg-[#f4efe3] font-sans overflow-x-hidden">
    ...
    <div id="alert-container" class="fixed top-4 right-4 z-50 space-y-2 w-80 max-w-[calc(100%-2rem)]">
        @if(session('success'))
            <div
                class="alert alert-success bg-green-100 border-l-4 border-green-500 text-green-700 p-3 rounded-lg shadow-lg flex items-start gap-2 animate-slide-in-right">
        ...
        @if(session('error'))
            <div
                class="alert alert-error bg-red-100 border-l-4 border-red-500 text-red-700 p-3 rounded-lg shadow-lg flex items-start gap-2 animate-slide-in-right">
        ...
        @if(session('warning'))
            <div
                class="alert alert-warning bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 rounded-lg shadow-lg flex items-start gap-2 animate-slide-in-right">
        ...
        @if(session('info'))
            <div
                class="alert alert-info bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-3 rounded-lg shadow-lg flex items-start gap-2 animate-slide-in-right">
