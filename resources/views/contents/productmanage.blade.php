...
@section('content')
    ...
    <div class="overflow-x-hidden">
        ...
        {{-- PERBAIKAN 1: Statistik Cards jadi responsive --}}
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6">
            <div class="bg-white rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-5 shadow">
                <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#c9973a] flex items-center justify-center shrink-0">
                    <svg width="20" height="20" sm:width="24" sm:height="24" fill="none" stroke="white" stroke-width="2.5" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-2xl p-4 sm:p-5 flex items-center gap-4 sm:gap-5 shadow">
                <div class="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#c9973a] flex items-center justify-center shrink-0">
                    <svg width="20" height="20" sm:width="24" sm:height="24" fill="none" stroke="white" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <span class="bg-[#c9973a] text-white text-xs sm:text-sm font-semibold px-4 sm:px-5 py-1.5 sm:py-2 rounded-xl inline-block">
    ...
    {{-- WRAPPER TABEL - TANPA margin negatif --}}
    <div style="overflow-x: auto; width: 100%;">
        <table style="min-width: 600px; width: 100%; border-collapse: collapse;">
            <thead>
                <tr class="bg-[#f3e4c3]">
                    <th style="padding: 12px 8px; text-align: left; font-weight: 600; color: #7a5c1e; font-size: 12px; border-top-left-radius: 12px;">Image</th>
                    ...
                    @foreach($products as $p)
                        ...
                        <tr style="border-bottom: 1px solid #f3e4c3;">
                            <td style="padding: 12px 8px;">
                                <img src="{{ $imageUrl }}" alt="{{ $productName }}" style="width: 45px; height: 45px; object-fit: cover; border-radius: 12px;">
                            </td>
