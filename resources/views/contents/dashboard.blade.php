...
@section('content')
    ...
    <div class="bg-white p-8 rounded-2xl mb-8 shadow-md border border-[#e7ddcf]">
        ...
        <p class="text-[#8b7a66] text-base mt-2">
            Selamat datang di Dashboard {{ auth()->user()->role->role_name === 'admin' ? 'Admin' : 'Operator' }} Luxury Furniture
        </p>
    </div>

    <!-- Cards - 4 card untuk admin -->
    @if(auth()->user()->role->role_name === 'admin')
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <!-- Card Total Produk -->
        <div class="bg-white rounded-2xl shadow-md p-6 flex items-center justify-between border-l-4 border-l-[#b68b40] hover:shadow-lg transition-all duration-200">
            <div>
        ...
        <!-- Card Total Kategori -->
        <div class="bg-white rounded-2xl shadow-md p-6 flex items-center justify-between border-l-4 border-l-[#8faa7b] hover:shadow-lg transition-all duration-200">
            <div>
        ...
        <!-- Card Total Users -->
        <div class="bg-white rounded-2xl shadow-md p-6 flex items-center justify-between border-l-4 border-l-[#c9a87b] hover:shadow-lg transition-all duration-200">
            <div>
        ...
        <!-- Card Total Stok -->
        <div class="bg-white rounded-2xl shadow-md p-6 flex items-center justify-between border-l-4 border-l-[#ab8e64] hover:shadow-lg transition-all duration-200">
            <div>
    ...
    <!-- Charts - Ukuran lebih besar -->
<div class="grid grid-cols-1 {{ auth()->user()->role->role_name === 'admin' ? 'lg:grid-cols-3' : 'lg:grid-cols-2' }} gap-6">
    
    <!-- Chart Produk - GANTI DENGAN INI -->
