...
<head>
    ...
    <meta name="dashboard-url" content="{{ route('contents.operator.dashboard') }}">
    <title>Product Management - Operator Luxury Furniture</title>
                                    ...
                                    <tr class="border-b border-[#f3e4c3] hover:bg-[#fdf8f0] transition-colors">
                                        ...
                                        <td class="px-3 py-3 text-center">
                                            <div class="inline-flex items-center gap-2">
                                                ...
                                                <form method="POST"
                                                    action="{{ route('contents.operator.products.destroy', $p->id) }}"
                                                    class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
