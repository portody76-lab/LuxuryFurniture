...
<head>
    ...
    <meta name="product-manage-url" content="{{ route('contents.operator.productmanage') }}">
    <title>Trash - Product Management | Operator Luxury Furniture</title>

    @vite(['resources/css/app.css', 'resources/js/operator/productmanage.js'])
                                    ...
                                    <tr class="border-b border-[#f3e4c3] hover:bg-[#fdf8f0] transition-colors bg-red-50">
                                        <td class="px-3 py-3">
                                            <img src="{{ $imageUrl }}" alt="{{ $productName }}"
                                                class="w-14 h-14 object-cover rounded-xl opacity-50">
                                        </td>
                                        ...
                                        <td class="px-3 py-3">
                                            <span class="bg-gray-200 text-gray-500 text-xs font-medium px-3 py-1 rounded-lg">
                                                {{ $categoryName }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="px-3 py-3 text-center">
                                            <div class="inline-flex items-center gap-2">
                                                {{-- Tombol Restore --}}
                                                <form method="POST" action="{{ route('contents.operator.products.restore', $p->id) }}" class="inline">
                                                    @csrf
                                                    <button type="submit" class="bg-[#c9973a] hover:bg-[#e8d5a8] text-white p-2 rounded-lg transition-colors" title="Restore">
                                ...
                                <tr>
                                    <td colspan="6" class="px-4 py-8 text-center text-gray-500">
                                        <div class="flex flex-col items-center gap-2">
                                            <i class="fas fa-trash-alt text-4xl text-gray-300"></i>
