        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all modal-transition">
            ...
            <form method="POST" action="{{ route('contents.admin.categories.store') }}">
                ...
                <div class="border-t border-gray-100 px-6 py-4 flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2 bg-[#8faa7b] hover:bg-[#7a9666] text-white rounded-lg transition shadow-sm flex items-center gap-2">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all modal-transition">
            ...
            <form id="editForm" method="POST">
                ...
                <div class="border-t border-gray-100 px-6 py-4 flex justify-end gap-3">
                    ...
                    <button type="submit"
                        class="px-5 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition shadow-sm flex items-center gap-2">
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-4 transform transition-all modal-transition">
            ...
            <div class="border-t border-gray-100 px-6 py-4 flex justify-end gap-3">
                <form id="deleteForm" method="POST">
                    ...
                    <button type="submit"
                        class="px-5 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg transition shadow-sm">
                        Ya, Hapus
                    </button>
                </form>
            </div>
